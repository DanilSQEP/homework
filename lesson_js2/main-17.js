...
const number = +prompt("Введите любое целое число:");
if (number % 2 === 0) {
...
const weight = +prompt("Введите массу посылки (в килограммах):");
const typeDelivery = prompt("Введите тип посылки:");
const arrTypeDelivery = ["Стандарт", "Экспресс", "Премиум"];

if (weight <= 0) {
  alert("Некорректный вес посылки");
} else if (!arrTypeDelivery.includes(typeDelivery)) {
